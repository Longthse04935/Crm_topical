...
-- Dumping database structure for crm_topica
CREATE DATABASE IF NOT EXISTS `crm_topica` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci */;
USE `crm_topica`;

-- Dumping structure for table crm_topica.comment
...
-- Dumping data for table crm_topica.comment: ~2 rows (approximately)
/*!40000 ALTER TABLE `comment` DISABLE KEYS */;
INSERT INTO `comment` (`comment_id`, `post_id`, `full_name`, `email`, `comment_content`, `created_date`) VALUES
	(1, 1, 'test', 'test@gmail.com', 'test', '2018-01-05'),
	(8, 1, 'hello', 'test', '1111', '2018-01-05');
/*!40000 ALTER TABLE `comment` ENABLE KEYS */;

-- Dumping structure for table crm_topica.crm_c3
CREATE TABLE IF NOT EXISTS `crm_c3` (
  `c3_id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`c3_id`)
) ENGINE=InnoDB AUTO_INCREMENT=85719 DEFAULT CHARSET=latin1;

-- Dumping data for table crm_topica.crm_c3: ~133 rows (approximately)
/*!40000 ALTER TABLE `crm_c3` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `crm_c3` ENABLE KEYS */;

-- Dumping structure for table crm_topica.crm_c4
CREATE TABLE IF NOT EXISTS `crm_c4` (
  `c4_id` int(11) NOT NULL AUTO_INCREMENT,
...
-- Dumping data for table crm_topica.crm_c4: ~104 rows (approximately)
/*!40000 ALTER TABLE `crm_c4` DISABLE KEYS */;
INSERT INTO `crm_c4` (`c4_id`, `c3_id`, `c3_datereg`, `c3_name`, `c3_tel`, `c3_email`, `c3_nganhdangky`, `c3_bangcapcaonhat`, `c3_diachinoio`, `truong`, `SP`, `khuvuc`, `CMND_CCCD`, `NoiCap`, `NgayCap`, `NgaySinh`, `GioiTinh`, `NguyenQuan`, `HKTT`, `Dia_Chi_Noi_O`, `TrinhDo`, `NamTotNghiep`, `NganhTotNghiep`, `DonViCapBang`, `LoaiTotNghiep`, `HeDaoTao`, `TruongChamSoc`, `NganhMuonHoc`, `user_id`, `last_c3_datereg`, `last_calllog`, `last_calllog_dtevisit`, `dte_datevisit`, `level_id`, `status_id`, `dteNextDate`, `ghi_chu`, `created_by`) VALUES
	...
	(9557, 85603, '2018-12-25 09:23:53', 'Lê Hoài Vân Thương', '399886379', 'lehoaivanthuong15@gmail.com', 'Kế toán', '', '', 'EHOU', 'GAS', 'HCM', '', '', '1970-01-01', '1970-01-01', 1, '', '', '', 'Trung học phổ thông', '', '', '', '', 'Đại học vừa học vừa làm', '', '', 12, '2019-01-01 00:43:33', '', NULL, '2019-01-03 13:06:39', 23, 5, '1970-01-01 00:00:00', '', ''),
	...
	(9563, 85633, '2018-12-25 17:17:51', 'Thuận', '914175976', 'thuanbs@gmail.com', 'đã TN ĐH, đang làm bác sỹ,học Văn bằng 2 ngôn ngữ ', '', NULL, 'EHOU', 'HOT', 'HCM', '', '', '1970-01-01', '1970-01-01', 1, '', '', '', 'Trung học phổ thông', '', '', '', '', 'Đại học vừa học vừa làm', '', '', 12, '2019-01-01 00:43:33', '', NULL, '2019-01-03 14:44:30', 22, 1, '1970-01-01 00:00:00', '', ''),
	...
	(9566, 85668, '2018-12-26 00:35:01', 'Vân', '932040055', 'nguyen1989@gmail.com', 'kế_toán', '', NULL, 'EHOU', 'FBA', 'HCM', '', '', '0000-00-00', '0000-00-00', 1, '', '', '', 'Trung học phổ thông', '', '', '', '', 'Đại học vừa học vừa làm', '', '', 0, '2019-01-01 00:43:33', '', NULL, '2019-01-02 14:01:32', 1, 1, '0000-00-00 00:00:00', '', 'status-1-12'),
	...
	(9569, 85601, '2018-12-25 09:13:59', 'tạ ngọc trâm', '967428160', 'tangoctram.25595@gmail.com', 'Luật kinh tế', '', '', 'EHOU', 'GAS', 'HCM', '', '', '1970-01-01', '1970-01-01', 1, '', '', '', 'Trung học phổ thông', '', '', '', '', 'Đại học vừa học vừa làm', '', '', 0, '2019-01-01 00:43:33', '', NULL, '2019-01-03 12:56:30', 19, 1, '1970-01-01 00:00:00', '', 'status-1-12'),
	...
	(9579, 85632, '2018-12-25 17:17:51', 'Ẩn danh', '3654471682', 'kimtinh22112001@gmail.com', 'Cho e hỏi là học công nghệ máy móc thì đầu vào là ', '', NULL, 'HCMUTE', 'SUP', 'HCM', '', '', '1970-01-01', '1970-01-01', 1, '', '', '', 'Trung học phổ thông', '', '', '', '', 'Đại học vừa học vừa làm', '', '', 0, '2019-01-01 00:43:33', '', NULL, '2019-01-03 12:55:50', 21, 2, '2019-01-04 00:00:00', '', 'status-1-12'),
...
/*!40000 ALTER TABLE `crm_c4` ENABLE KEYS */;

-- Dumping structure for table crm_topica.crm_calllog
...
-- Dumping data for table crm_topica.crm_calllog: ~101 rows (approximately)
/*!40000 ALTER TABLE `crm_calllog` DISABLE KEYS */;
INSERT INTO `crm_calllog` (`calllog_id`, `level_id`, `calllog`, `user_id`, `dte_checkin`, `dte_datevisit`, `status_id`, `c4_id`, `dteNextDate`) VALUES
	...
	(82, 1, '', 12, '2019-01-02 14:01:28', '2019-01-02 14:01:32', 1, 9566, '0000-00-00 00:00:00'),
	(83, 18, '', 12, '2019-01-02 14:01:48', '2019-01-02 14:02:02', 3, 9569, '0000-00-00 00:00:00'),
	(84, 20, '', 12, '2019-01-02 14:02:25', '2019-01-02 14:02:36', 3, 9579, '2019-01-04 00:00:00'),
	(85, 21, '', 12, '2019-01-03 12:55:43', '2019-01-03 12:55:50', 1, 9579, '2019-01-04 00:00:00'),
	(86, 19, '', 12, '2019-01-03 12:56:19', '2019-01-03 12:56:30', 1, 9569, '1970-01-01 00:00:00'),
	(87, 21, '', 12, '2019-01-03 12:57:26', '2019-01-03 13:00:11', 3, 9557, '1970-01-01 00:00:00'),
	(88, 23, '', 12, '2019-01-03 13:06:22', '2019-01-03 13:06:39', 5, 9557, '1970-01-01 00:00:00'),
	(89, 12, '', 12, '2019-01-03 13:18:33', '2019-01-03 13:18:56', 2, 9563, '0000-00-00 00:00:00'),
	(90, 13, '', 12, '2019-01-03 14:16:44', '2019-01-03 14:17:00', 1, 9563, '1970-01-01 00:00:00'),
	(91, 13, '', 12, '2019-01-03 14:17:01', '2019-01-03 14:17:49', 1, 9563, '1970-01-01 00:00:00'),
	(92, 14, '', 12, '2019-01-03 14:19:50', '2019-01-03 14:19:58', 1, 9563, '1970-01-01 00:00:00'),
	(93, 15, '', 12, '2019-01-03 14:41:02', '2019-01-03 14:41:38', 1, 9563, '1970-01-01 00:00:00'),
	(94, 7, '', 12, '2019-01-03 14:42:05', '2019-01-03 14:42:20', 2, 9563, '1970-01-01 00:00:00'),
	(95, 13, '', 12, '2019-01-03 14:42:22', '2019-01-03 14:42:30', 1, 9563, '1970-01-01 00:00:00'),
	(96, 14, '', 12, '2019-01-03 14:42:34', '2019-01-03 14:42:45', 1, 9563, '1970-01-01 00:00:00'),
	(97, 14, '', 12, '2019-01-03 14:42:50', '2019-01-03 14:42:58', 1, 9563, '1970-01-01 00:00:00'),
	(98, 15, '', 12, '2019-01-03 14:43:00', '2019-01-03 14:43:14', 1, 9563, '1970-01-01 00:00:00'),
	(99, 16, '', 12, '2019-01-03 14:43:16', '2019-01-03 14:43:22', 1, 9563, '1970-01-01 00:00:00'),
	(100, 17, '', 12, '2019-01-03 14:43:25', '2019-01-03 14:43:30', 1, 9563, '1970-01-01 00:00:00'),
	(101, 20, '', 12, '2019-01-03 14:43:32', '2019-01-03 14:43:39', 1, 9563, '1970-01-01 00:00:00'),
	(102, 21, '', 12, '2019-01-03 14:44:08', '2019-01-03 14:44:17', 1, 9563, '1970-01-01 00:00:00'),
	(103, 22, '', 12, '2019-01-03 14:44:21', '2019-01-03 14:44:30', 1, 9563, '1970-01-01 00:00:00');
/*!40000 ALTER TABLE `crm_calllog` ENABLE KEYS */;

-- Dumping structure for table crm_topica.crm_group
...
-- Dumping data for table crm_topica.crm_group: ~3 rows (approximately)
...
-- Dumping structure for table crm_topica.crm_level
CREATE TABLE IF NOT EXISTS `crm_level` (
...
-- Dumping data for table crm_topica.crm_level: ~20 rows (approximately)
/*!40000 ALTER TABLE `crm_level` DISABLE KEYS */;
INSERT INTO `crm_level` (`level_id`, `level_name`, `level_diengiai_id`, `level_diengiai`) VALUES
	...
	(16, 'L5A', 15, 'Chỉ mua hồ sơ để về nhà làm'),
	(17, 'L5B', 16, 'Nộp lệ phí xét tuyển hoặc thi tuyển nhưng thiết hồ sơ công chứng'),
	(20, 'L6', 17, ' Xét tuyển: Gửi hồ sơ qua trường xét tuyển'),
	(21, 'L7', 18, ' Có tên trong danh sách trúng tuyển của nhà trường'),
	(22, 'L8', 19, ' Đã nộp đủ học phí'),
	(23, 'L9', 20, 'Đã nhập học');
/*!40000 ALTER TABLE `crm_level` ENABLE KEYS */;

-- Dumping structure for table crm_topica.crm_role
...
-- Dumping data for table crm_topica.crm_role: ~4 rows (approximately)
...
-- Dumping structure for table crm_topica.crm_status
...
-- Dumping data for table crm_topica.crm_status: ~5 rows (approximately)
...
-- Dumping structure for table crm_topica.crm_user
...
-- Dumping data for table crm_topica.crm_user: ~12 rows (approximately)
...
-- Dumping structure for table crm_topica.post
CREATE TABLE IF NOT EXISTS `post` (
  `post_id` int(11) NOT NULL AUTO_INCREMENT,
  `username` varchar(50) NOT NULL,
  `post_title` varchar(100) NOT NULL,
  `post_content` varchar(2000) NOT NULL,
  `sub_content` varchar(50) NOT NULL,
  `post_state` bit(1) NOT NULL,
  `created_date` date NOT NULL,
  PRIMARY KEY (`post_id`),
...
-- Dumping data for table crm_topica.post: ~4 rows (approximately)
/*!40000 ALTER TABLE `post` DISABLE KEYS */;
INSERT INTO `post` (`post_id`, `username`, `post_title`, `post_content`, `sub_content`, `post_state`, `created_date`) VALUES
	(1, 'admin', 'Hello, This is first post', '<p><strong>This is content aaaaaaaaaaaaaaaaaaaaaaa</strong></p><p><strong><span style="font-size: 72px;">that is awesome</span></strong></p><p><br></p><p><strong><span style="font-size: 72px;">WWOWWW</span></strong></p>', 'This is content aaaaaaaaaaaaaaaaaaaaaaathat is a.', b'0', '2018-01-05'),
	(2, 'admin', 'Hello', '<p><strong><span style="font-family: Impact, Charcoal, sans-serif; font-size: 24px;">WOW This is my post</span></strong></p><p><br></p><p><strong><span style="font-family: Impact, Charcoal, sans-serif; font-size: 24px;">TEST NOW !!!!</span></strong></p>', 'WOW This is my postTEST NOW !!!!.', b'1', '2018-01-05'),
	(3, 'test', 'This post of tester', '<p><strong>Hello every one!!&nbsp;</strong></p><p><br></p><p><br></p><p><strong><span style="color: rgb(84, 172, 210);">aaaaaaaaaaaaaa&nbsp;</span></strong></p><p><strong><span style="color: rgb(84, 172, 210);">bbbbbbbbbbbbbbb</span></strong></p><p><strong><span style="color: rgb(84, 172, 210);">ccccccccccccccccccc</span></strong></p>', 'Hello every one!!&nbsp;aaaaaaaaaaaaaa&nbsp;bbbbb.', b'1', '2018-01-05'),
	(4, 'admin', 'x', '<p>test</p>', 'test.', b'1', '2018-01-05');
/*!40000 ALTER TABLE `post` ENABLE KEYS */;

-- Dumping structure for table crm_topica.tuyensinh
...
-- Dumping data for table crm_topica.tuyensinh: 1 rows
...
INSERT INTO `tuyensinh` (`id`, `hoten`, `namsinh`, `diachi`, `email`, `dienthoai`, `truongtotnghiep`, `nganhhoc`, `nguon`, `ip`, `is_chuyen`, `reg_date`, `cmnd`, `dia_chi_giay_bao`, `khu_vuc`, `form_code`, `ghi_chu`, `for_count`, `trang_thai`) VALUES
	(1, 'Son Tran', '1985', 'Tu Son - Bac Nih', 'test@gail.com', '353475474', 'TLU', 'CNTT', 'HH.KK.GSG', NULL, 'N', '2019-01-01 00:00:00', '0', '', 'HN', '000', 'Ghi chu', 1, 'UNVERIFIED');
/*!40000 ALTER TABLE `tuyensinh` ENABLE KEYS */;

-- Dumping structure for table crm_topica.user
...
-- Dumping data for table crm_topica.user: ~2 rows (approximately)
